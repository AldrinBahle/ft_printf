...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/07/29 12:38:44 by agama             #+#    #+#             */
/*   Updated: 2018/08/07 11:40:17 by agama            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** thanks to tfleming for the right clue towards this function (github.com)
*/
...
static size_t	count_wide_chars(t_conversion *conversion, wchar_t *string
								, size_t *length)
{
	size_t		i;
	size_t		total_bytes;
